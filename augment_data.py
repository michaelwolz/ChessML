...
if __name__ == "__main__":
    augment_images("data/eval_augmented/bb/")
    augment_images("data/eval_augmented/bk/")
    augment_images("data/eval_augmented/bn/")
    augment_images("data/eval_augmented/bp/")
    augment_images("data/eval_augmented/bq/")
    augment_images("data/eval_augmented/br/")
    augment_images("data/eval_augmented/wb/")
    augment_images("data/eval_augmented/wk/")
    augment_images("data/eval_augmented/wn/")
    augment_images("data/eval_augmented/wp/")
    augment_images("data/eval_augmented/wq/")
    augment_images("data/eval_augmented/wr/")
